...
const EL_HJ  = { wood:'木', fire:'火', earth:'土', metal:'金', water:'水' };
const EL_KR  = { wood:'목', fire:'화', earth:'토', metal:'금', water:'수' };
const EL_COL = { wood:'#6fcf6f', fire:'#cf5050', earth:'#c8a000', metal:'#a0a0d0', water:'#5090c8' };
const EL_ORD = ['wood','fire','earth','metal','water'];
...
/* ─ 전체 계산 묶음 ─ */
function calcAll(year, month, day, hour, name, gender) {
